...
export const LinkedinIcon: React.FC<CustomIconProps> = ({ className = '', ...rest }) => {
  return (
    <svg
...
export const GithubIcon: React.FC<CustomIconProps> = ({ className = '', ...rest }) => {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      width={42}
...
export const TwitterIcon: React.FC<CustomIconProps> = ({ className = '', ...rest }) => {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      width={42}
...
export const DribbleIcon: React.FC<CustomIconProps> = ({ className = '', ...rest }) => {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      width={42}
